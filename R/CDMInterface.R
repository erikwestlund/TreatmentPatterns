    ...
    dbconFetchCohortTable = function(cohorts, cohortTableName, andromeda, andromedaTableName, minEraDuration) {
      ...
      DatabaseConnector::renderTranslateQuerySqlToAndromeda(
        ...
        SELECT 
          ...
          DATEDIFF(DAY, CAST('19700101' AS DATE), #tp_dbc_cohort_table.cohort_start_date) AS cohort_start_date,
          DATEDIFF(DAY, CAST('19700101' AS DATE), #tp_dbc_cohort_table.cohort_end_date) AS cohort_end_date,
