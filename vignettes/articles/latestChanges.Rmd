...
As of TreatmentPatterns `2.6.10` TreatmentPatterns will assign it's own pseudo subject ID's. This is due to subject ID's in the database may be 64 bit integers, or may contain letters. This can lead to strange edge cases where ID's get rounded, and results of different individuals will be grouped together.
